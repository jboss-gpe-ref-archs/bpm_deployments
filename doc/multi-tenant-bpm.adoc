...
At the same kie-config-cli command prompt, execute the following:
...
Now that an organization unit of *gpe* and a BPM bare git repo of *gperepo* have been created, the next step is to create two new KIE projects.
